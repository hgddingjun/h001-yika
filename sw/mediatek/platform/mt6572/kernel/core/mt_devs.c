...
/*d.j add 2014.10.17*/
#if defined(CONFIG_LTK_AW9523)
struct platform_device aw9523_device = {
	.name	  ="aw9523",
	.id		  = -1,
};
#endif
...
/*d.j add 2014.11.07*/
#if defined(CONFIG_LTK_BT803)
struct platform_device bt803_device = {
	.name	  ="BT803_Driver",
	.id		  = -1,
};
#endif
...
/*d.j add 2014.11.17*/
#if defined(CONFIG_LTK_QN8006)
struct platform_device qn8006_device = {
	.name	  ="QN8006_Driver",
	.id		  = -1,
};
#endif
...
/*d.j add 2014.10.17*/
#if defined(CONFIG_LTK_AW9523)
    retval = platform_device_register(&aw9523_device);
	printk("register aw9523 device\n");

	if (retval != 0)
	{
		printk("platform_device_aw8523_register error:(%d)\n", retval);
		return retval;
	}
	else
	{
		printk("platform_device_aw9523_register done!\n");
	}
#endif

/*d.j add 2014.11.07*/
#if defined(CONFIG_LTK_BT803)
    retval = platform_device_register(&bt803_device);
	printk("register bt803 device\n");

	if (retval != 0)
	{
		printk("platform_device_bt803_register error:(%d)\n", retval);
		return retval;
	}
	else
	{
		printk("platform_device_bt803_register done!\n");
	}
#endif

/*d.j add 2014.11.07*/
#if defined(CONFIG_LTK_QN8006)
    retval = platform_device_register(&qn8006_device);
	printk("register qn8006 device\n");

	if (retval != 0)
	{
		printk("platform_device_qn8006_register error:(%d)\n", retval);
		return retval;
	}
	else
	{
		printk("platform_device_qn8006_register successfully!\n");
	}
#endif
